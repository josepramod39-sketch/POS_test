    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex gap-6">
            ...
            <a href="#inventory" className="text-sm font-semibold hover:text-violet-600 transition-colors uppercase tracking-wider">Inventory</a>
      ...
      {mobileMenuOpen && (
        <div className="absolute top-full left-0 right-0 bg-white border-b border-gray-100 p-6 flex flex-col gap-4 md:hidden animate-in fade-in slide-in-from-top-4">
          ...
          <a href="#inventory" className="text-lg font-bold" onClick={() => setMobileMenuOpen(false)}>Inventory</a>
