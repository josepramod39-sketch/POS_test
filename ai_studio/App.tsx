           ...
           <div className="max-w-7xl mx-auto px-6 relative z-10">
              <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                 <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter leading-tight max-w-2xl">
                    Ready to leave the dongles behind? Join 1.2 Lakh+ modern merchants.
                 </h2>
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
             <div className="order-2 md:order-1">
                <div className="relative rounded-[2rem] overflow-hidden aspect-video shadow-2xl border border-gray-100">
                   <img src="https://images.unsplash.com/photo-1556742111-a301076d9d18?auto=format&fit=crop&q=80&w=1200" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-1000" alt="Remote payments" />
             ...
             <div className="order-1 md:order-2">
                ...
                <p className="text-xl text-gray-500 mb-8 leading-snug">
                  Send simple payment links via text, WhatsApp, or email. Your customers pay securely in their browser, you get the funds in seconds.
                </p>
